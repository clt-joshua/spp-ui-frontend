...
| `03-delivery` | 구현 순서, 검증, AI 작업 방식 | [구현·검증](03-delivery/06-IMPLEMENTATION-AND-VALIDATION.md), [플레이북](03-delivery/07-VIBE-CODING-PLAYBOOK.md), [CI/visual 운영 기준](03-delivery/08-CI-AND-VISUAL-BASELINE-PROPOSAL.md) |
